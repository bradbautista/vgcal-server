...
const releasesService = {
  getAllRooms(knex) {
    return knex.select('conversation_location').from('gifchat_conversations');
  },
  ...
  getRoomName() {
    ...
    if (
      randomName.charAt(2) === 'a' ||
      randomName.charAt(2) === 'e' ||
      randomName.charAt(2) === 'i' ||
      randomName.charAt(2) === 'o' ||
      randomName.charAt(2) === 'u'
    ) {
